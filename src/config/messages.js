...
export const MESSAGES = {
  ...
  ERROR_NO_GROUP_SELECTED:
    '❌ <b>Группа не выбрана</b>\n\nПожалуйста, сначала выберите группу для получения расписания.',
  ...
  BUTTON_TODAY_TIMETABLE: '📅 Расписание на сегодня',
  BUTTON_SELECT_DAY_TIMETABLE: '📆 Расписание на ...',
  ...
  TIMETABLE_SELECT_DAY: '📆 <b>Выберите день недели:</b>',
